...
namespace TextApp
{
    public partial class frmChat : Form
    {
        ...
        static readonly List<TcpConnection> connectedClients = new List<TcpConnection>();

        // Method to broadcast a message to all connected clients
        public bool TrySendToAllClients(string message, List<TcpConnection> clients)
        {
            try
            {
                foreach (TcpConnection client in clients)
                {
            ...
            try
            {
                ...
                while (!closeFlag)
                {
                    ...
                    switch (serverState)
                    {
                        ...
                        case Tcp.SENDING:
                            if (TrySendToAllClients(sendingString, connectedClients))
                            {
                                serverTextboxBig.Invoke((MethodInvoker)delegate {
